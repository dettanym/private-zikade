...
func NewPirClientPeerRouting() *PirClientPeerRouting {
	return &PirClientPeerRouting{
		PirClient: PirClient{
			protocol: pir.NewSimpleRLWE_PIR_Protocol(8),
		},
	}
}
...
func NewPirClientProviderRouting(log2_num_buckets int) *PirClientProviderRouting {
	return &PirClientProviderRouting{
		log2_num_buckets: log2_num_buckets,
		PirClient: PirClient{
			protocol: pir.NewSimpleRLWE_PIR_Protocol(log2_num_buckets),
		},
	}
}
